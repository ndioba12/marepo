package sn.gainde2000.fichedotation.web.dtos.messages.responses;
...
public class Response<T> {
    ...
    public static <T> Response<?> unsupportedMediaType() {
        return Response.builder().status(Status.UNSUPPORTED_MEDIA_TYPE).build();
    }

    public static <T> Response<?> directoryNotFound() {
        return Response.builder().status(Status.DIRECTORY_NOT_FOUND).build();
    }
