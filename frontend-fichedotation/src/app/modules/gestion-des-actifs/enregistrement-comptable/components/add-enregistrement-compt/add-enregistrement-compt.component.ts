...
@Component({
  selector: 'app-add-enregistrement-compt',
  templateUrl: './add-enregistrement-compt.component.html',
  styleUrls: ['./add-enregistrement-compt.component.css']
})
export class AddEnregistrementComptComponent implements OnInit {
