...
@Component({
  selector: 'app-list-enregistrement-compt',
  templateUrl: './list-enregistrement-compt.component.html',
  styleUrls: ['./list-enregistrement-compt.component.css']
})
export class ListEnregistrementComptComponent implements OnInit {
  ...
  addMateriel(): void {
    this.router.navigate(['/gestion-des-actifs/liste-des-materiels/enregistrement-materiel'])
  }
